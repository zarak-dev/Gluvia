...
export const metadata: Metadata = {
  title: "Forgot Password - Gluvia",
  description:
    "Reset your Gluvia account password to regain access to your diabetes health dashboard.",
};
          ...
          <div className="relative z-10 space-y-3">
            ...
            <div className="space-y-1">
              <p className="text-lg font-semibold text-foreground tracking-tight leading-snug">
                Your health records stay protected.
              </p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Recover your access securely to continue managing your glucose
                patterns, nutrition plans, and clinical reports.
              </p>
            </div>
          </div>
        </div>
