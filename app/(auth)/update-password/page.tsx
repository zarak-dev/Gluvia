...
import { Activity, ShieldCheck, Sparkles, Loader2 } from "lucide-react";

import { UpdatePasswordForm } from "@/components/forms/UpdatePasswordForm";

export const metadata: Metadata = {
  title: "Create New Password - Gluvia",
  description:
    "Set a new secure password for your Gluvia diabetes management account.",
};

function FormFallback(): React.ReactElement {
  return (
    <div className="py-12 flex flex-col items-center justify-center space-y-3 text-center" role="status">
      <Loader2 className="h-8 w-8 animate-spin text-primary" />
      <p className="text-xs text-muted-foreground">Loading password recovery...</p>
    </div>
  );
}
...
export default function UpdatePasswordPage(): React.ReactElement {
  return (
    <main className="min-h-screen w-full bg-muted/30 flex items-center justify-center p-3.5 sm:p-6 lg:p-8">
      <div className="w-full max-w-5xl overflow-hidden rounded-2xl sm:rounded-3xl border border-border/60 bg-card shadow-xl grid grid-cols-1 lg:grid-cols-12 min-h-[620px]">
          ...
          <div className="relative z-10 space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Choose a strong, unique password to ensure your glucose readings,
                lifestyle notes, and diet plans stay safe.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col justify-center p-5 sm:p-8 lg:p-12 bg-card">
          <div className="w-full max-w-md mx-auto space-y-5 sm:space-y-6">
            ...
            <div className="relative lg:hidden h-32 sm:h-36 w-full rounded-xl overflow-hidden shadow-xs border border-border/50">
              <Image
                src="/images/auth-medical.jpg"
            ...
            {/* Update Password Form wrapped in Suspense */}
