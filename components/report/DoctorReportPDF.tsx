  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {summaryText && (
          <View>
            <Text style={styles.sectionTitle}>AI Glycemic Analysis & Talking Points</Text>
        ...
        <View style={styles.disclaimerBox}>
          <Text style={styles.disclaimerText}>
            ...
            This report is an informational compilation generated by Gluvia to facilitate
            discussions between the patient and their licensed healthcare provider. The AI
            analysis and application thresholds do not constitute a clinical diagnosis or prescription.
          </Text>
        </View>
      </Page>
    </Document>
